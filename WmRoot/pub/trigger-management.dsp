    ...
    <tr>
      ...
      <table style="width: 100%;" class="tableView">
        <tbody>
          ...
          <tr>
            <td width="25%" class="subheading2" nowrap>Current Threads</td>
            %ifvar globalSettings/maximumDocumentRetrievalThreadsPct -notempty%
              <td width="25%" class="evenrow-l" nowrap>%value globalSettings/currentNumberDocumentRetrievalThreads encode(html)%</td>
            %else%
              <td width="25%" class="evenrow-l">N/A</td>
            %endif%
            <td width="25%" class="subheading2" nowrap>Current Threads</td>
            <td width="25%" class="evenrow-l" nowrap>%value globalSettings/currentNumberTriggerExecutionThreads encode(html)%</td>
          </tr>
          <tr>
            ...
            %else%
              <td class="oddrow-l" nowrap>N/A</td>
            %endif%
            <td class="subheading2" nowrap>Maximum Threads</td>
